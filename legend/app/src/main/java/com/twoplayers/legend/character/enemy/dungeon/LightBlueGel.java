...
public class LightBlueGel extends Gel {

    public LightBlueGel(IImagesEnemy i, SoundEffectManager s, IZoneManager z, LinkManager l, IEnemyManager e, EnemyService es, Graphics g) {
    ...
    protected void initAnimations(Graphics g) {
        ...
        animation.addFrame(imagesEnemy.get("light_blue_gel_1"), AllImages.COEF, 5);
        animation.addFrame(imagesEnemy.get("light_blue_gel_2"), AllImages.COEF, 5);
