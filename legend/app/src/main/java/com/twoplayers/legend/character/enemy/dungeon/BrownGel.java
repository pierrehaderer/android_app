...
public class BrownGel extends Gel {

    public BrownGel(IImagesEnemy i, SoundEffectManager s, IZoneManager z, LinkManager l, IEnemyManager e, EnemyService es, Graphics g) {
    ...
    protected void initAnimations(Graphics g) {
        ...
        animation.addFrame(imagesEnemy.get("brown_gel_1"), AllImages.COEF, 5);
        animation.addFrame(imagesEnemy.get("brown_gel_2"), AllImages.COEF, 5);
