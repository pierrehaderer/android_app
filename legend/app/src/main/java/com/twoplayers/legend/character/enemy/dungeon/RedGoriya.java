...
public class RedGoriya extends Goriya {
     ...
     * Constructor
     */
    public RedGoriya(SoundEffectManager s, IZoneManager z, LinkManager l, IEnemyManager e, EnemyService es) {
        super(s, z, l, e, es);
        life = INITIAL_LIFE;
        speed = SPEED;
        damage = DAMAGE;
    ...
    protected void initAnimations(IImages imagesEnemy, Graphics g) {
        ...
        animationUp.addFrame(imagesEnemy.get("red_goriya_up_1"), AllImages.COEF, 15);
        animationUp.addFrame(imagesEnemy.get("red_goriya_up_2"), AllImages.COEF, 15);
        moveAnimations.put(Orientation.UP, animationUp);
        Animation animationDown = g.newAnimation();
        animationDown.addFrame(imagesEnemy.get("red_goriya_down_1"), AllImages.COEF, 15);
        animationDown.addFrame(imagesEnemy.get("red_goriya_down_2"), AllImages.COEF, 15);
        moveAnimations.put(Orientation.DOWN, animationDown);
        Animation animationLeft = g.newAnimation();
        animationLeft.addFrame(imagesEnemy.get("red_goriya_left_1"), AllImages.COEF, 15);
        animationLeft.addFrame(imagesEnemy.get("red_goriya_left_2"), AllImages.COEF, 15);
        moveAnimations.put(Orientation.LEFT, animationLeft);
        Animation animationRight = g.newAnimation();
        animationRight.addFrame(imagesEnemy.get("red_goriya_right_1"), AllImages.COEF, 15);
        animationRight.addFrame(imagesEnemy.get("red_goriya_right_2"), AllImages.COEF, 15);
